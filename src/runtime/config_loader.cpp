...
void apply_config_value(CoreStackProviderConfig& config, const std::string& key, const std::string& value) {
    ...
    } else if (key == "airsim_transport") {
        config.airsim_transport = value;
    } else if (key == "airsim_bridge_command") {
        config.airsim_bridge_command = value;
    } else if (key == "airsim_bridge_mode") {
        config.airsim_bridge_mode = value;
    } else if (key == "airsim_ego_bridge_command") {
        config.airsim_ego_bridge_command = value;
