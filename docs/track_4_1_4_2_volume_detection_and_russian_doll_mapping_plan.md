# Track 4.1 / 4.2 — Arbitrary Volume Detection and Russian-Doll Flight Mapping

This document records the next Track 4 stages after the AirSim GT obstacle-source, swept-volume, overlay, and EFF profiling work.
