...
if [[ -n "${DEDALUS_DEPTH_CAPTURE_DIR:-}" ]]; then
    MISSION_ENV_VARS+=("DEDALUS_DEPTH_CAPTURE_DIR=$DEDALUS_DEPTH_CAPTURE_DIR")
fi
if [[ -n "${DEDALUS_DEPTH_DEBUG_DIR:-}" ]]; then
    MISSION_ENV_VARS+=("DEDALUS_DEPTH_DEBUG_DIR=$DEDALUS_DEPTH_DEBUG_DIR")
fi
if [[ -n "${DEDALUS_DEPTH_EVAL:-}" ]]; then
    MISSION_ENV_VARS+=("DEDALUS_DEPTH_EVAL=$DEDALUS_DEPTH_EVAL")
fi
if [[ "$WITH_SCENE_INVENTORY" -eq 1 ]]; then
