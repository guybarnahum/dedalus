...
if [[ "$OBSTACLE_MAP_ARTIFACT" -eq 1 ]]; then
    ...
    MISSION_ENV_VARS+=("DEDALUS_MISSION_OBSTACLE_MAP_DELTAS=1 DEDALUS_MISSION_OBSTACLE_MAP_DELTAS_PATH=$(printf %q "$MISSION_OBSTACLE_MAP_DELTAS_PATH") DEDALUS_MISSION_OBSTACLE_MAP_DELTAS_WRITE_EVERY_UPDATES=$(printf %q "$MISSION_OBSTACLE_MAP_DELTAS_WRITE_EVERY_UPDATES") DEDALUS_MISSION_OBSTACLE_MAP_PATH=$MISSION_OBSTACLE_MAP_ARTIFACT_PATH")
