...
8. For Track 4 obstacle avoidance / mapping / volume detection work, read these together before coding:
   - `docs/track_4_obstacle_avoidance_and_mapping_plan.md`
   - `docs/erodf_reflexive_avoidance_whitepaper.md`
   - `docs/track_4_1_4_2_volume_detection_and_russian_doll_mapping_plan.md`
9. Read `docs/milestone_2_30a_slow_moving_sel_animal_validation.md` and `docs/milestone_2_30b_results.md` when continuing moving-target/object-conditioned behavior work.
...
For Track 4 obstacle avoidance / arbitrary volume detection / mapping work, also read:
  docs/track_4_obstacle_avoidance_and_mapping_plan.md
  docs/erodf_reflexive_avoidance_whitepaper.md
  docs/track_4_1_4_2_volume_detection_and_russian_doll_mapping_plan.md
